...
@Component({
  selector: 'app-black-liste',
  templateUrl: './black-liste.component.html',
  styleUrls: ['./black-liste.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BlackListeComponent implements OnInit {
  activatelien = false;
